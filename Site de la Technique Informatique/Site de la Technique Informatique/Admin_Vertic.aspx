    ...
    <asp:MultiView ID="mvAdmin_Vertic" runat="server" ActiveViewIndex="0">
        <asp:View runat="server" ID="viewDefault">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <br />
                    <asp:Button ID="btnSauvegarder" runat="server" Text="Sauvegarder" CssClass="btn btn-primary" OnClick="btnSauvegarder_Click" />
                </div>
            </div>
        </asp:View>
        <asp:View runat="server" ID="viewFin">
            <div style="text-align: left">
                ...
                <asp:LinkButton ID="lnkRetour" Text="Ok" runat="server" CssClass="btn btn-primary" OnClick="lnkRetour_Click" />
            </div>
        </asp:View>
    </asp:MultiView>
</asp:Content>
