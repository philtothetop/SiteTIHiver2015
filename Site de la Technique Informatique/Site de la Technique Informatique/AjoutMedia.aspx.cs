    ...
    public partial class AjoutMedia : System.Web.UI.Page
    {
            ...
            try
            {
                using (LeModelTIContainer lecontexte = new LeModelTIContainer())
                {
                    ...
                    if (fuNewArticle.HasFile)
                        if (Path.GetExtension(fuNewArticle.PostedFile.FileName) == ".PDF")
                        {
        ...
        public void DeleteMedia(ParutionMedia leMediaASupprimer)
        {
            using (LeModelTIContainer lecontexte = new LeModelTIContainer())
                ...
                {
                    lblMessage.Text += "ERREUR DE SUPPRESSION D'UN EMPLOYÉ, " + ex.ToString();
                }
        }
        ...
        public IQueryable<ParutionMedia> GetMedia()
        {
            ...
            try
            {
                ...
                if ((string)ViewState["mode"] + "" == "ajoute")  // SEULEMENT UN MEDIA «VIDE»
                {
                    ...
                    mediaVide.dateParution = new DateTime(1900-01-01);
