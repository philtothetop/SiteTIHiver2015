...
public partial class UtilisateurValidation
{
    ...
    [Required(ErrorMessage = "L'adresse courriel est obligatoire"), StringLength(200, ErrorMessage = "L'adresse courriel ne doit pas dépasser 200 caractères"), RegularExpression(@"([-0-9a-zA-Z.+_]+@[-0-9a-zA-Z.+_]+\.[a-zA-Z]{2,4})|^admin$", ErrorMessage = "L'adresse courriel ne convient pas au bon format")]
