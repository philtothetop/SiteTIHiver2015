<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Log.aspx.cs" Inherits="Site_de_la_Technique_Informatique.Log" %>
        ...
        <asp:ListView ID="lviewLogs" runat="server"
            ...
            <EmptyDataTemplate>
                ...
                <asp:Button ID="btnVoirToutLesLogs" runat="server" Text="Tous" OnClick="ChercherUnTypeDeLog" CommandArgument="9000" style="width:14%; margin-left:1%; margin-right:1%;" CssClass="btn btn-default"  />
                            <asp:Button ID="btnVoirQueLogNormal" runat="server" Text="Éléments normaux" OnClick="ChercherUnTypeDeLog" CommandArgument="0" style="width:14%; margin-left:1%; margin-right:1%;" CssClass="btn btn-default"  />
                            <asp:Button ID="btnVoirQueLogErreur" runat="server" Text="Éléments erreurs" OnClick="ChercherUnTypeDeLog" CommandArgument="1" style="width:14%; margin-left:1%; margin-right:1%;" CssClass="btn btnErreur" />
                            <asp:Button ID="btnVoirQueLogWarning" runat="server" Text="Éléments warnings" OnClick="ChercherUnTypeDeLog" CommandArgument="2" style="width:14%; margin-left:1%; margin-right:1%;" CssClass="btn btnWarning" />
                            ...
                            <asp:Button ID="btnVoirQueLogBanni" runat="server" Text="Éléments bannissement" OnClick="ChercherUnTypeDeLog" CommandArgument="4" style="width:14%; margin-left:1%; margin-right:1%;" CssClass="btn btnBanissement"/>
            </div>
